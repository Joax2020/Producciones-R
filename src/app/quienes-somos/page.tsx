      ...
      <div className="relative z-10 text-center space-y-6 max-w-3xl mx-auto">
        ...
        <div className="pt-8">
          <a 
            ...
            className="bg-[#cc0000] hover:bg-red-600 text-white font-bold px-8 py-3 rounded uppercase tracking-wider transition-all duration-200 hover:scale-105 inline-block"
          >
            Contáctanos
          </a>
        </div>
